...
if __name__ == "__main__":
    ...
    #     shuffled_subsequences_with_errors = create_errors(shuffled_subsequences, random.randint(10,60), random.randint(10,60))
    ...
    for i in range(10):
        ...
        filenameoutput = f'output/output_{i + 1}_MROWKI_150_STEPS_5.txt'
